...
public interface YahtzeeConstants {
	...
	/** The scores for each category where the score is not determined by the values on the dice */
	public static final int UPPER_BONUS_SCORE_AMOUNT = 35;
	public static final int FULL_HOUSE_SCORE_AMOUNT = 25;
	public static final int SMALL_STRAIGHT_SCORE_AMOUNT = 30;
	public static final int LARGE_STRAIGHT_SCORE_AMOUNT = 40;
	public static final int YAHTZEE_SCORE_AMOUNT = 50;

	
	/** Upper score required to qualify for the upper bonus (inclusive) */
	public static final int UPPER_BONUS_REQUIREMENT = 63;
